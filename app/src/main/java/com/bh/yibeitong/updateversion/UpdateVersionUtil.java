...
public class UpdateVersionUtil {
     ...
     * 本地测试
     */
    public static void localCheckedVersion(final Context context,
                                           final UpdateListener updateListener,
                                           String version) {
        try {
            VersionInfo mVersionInfo = new VersionInfo();
            mVersionInfo.setDownloadUrl("http://www.ybt9.com/app/ybt.apk");
            //mVersionInfo.setVersionDesc("\n更新内容：\n1、增加xxxxx功能\n2、增加xxxx显示！\n3、用户界面优化！\n4、xxxxxx！");
            mVersionInfo.setVersionCode(1);
            mVersionInfo.setVersionName(version);
     ...
     */
    public static void showDialog(final Context context, final VersionInfo versionInfo, String v) {
        ...
        btnOk.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (v.getId() == R.id.btn_update_id_ok) {
                    ...
                    ApkUpdateUtils.download(context, "http://www.ybt9.com/app/ybt.apk", context.getResources().getString(R.string.app_name));
