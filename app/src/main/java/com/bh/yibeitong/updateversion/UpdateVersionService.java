package com.bh.yibeitong.updateversion;
...
public class UpdateVersionService extends Service {
    ...
    public void onCreate() {
        ...
        updateFile = new File(SDCardUtils.getRootDirectory() + "/ybt_updateVersion/ybt.apk");
        ...
        notification.contentView = new RemoteViews(getPackageName(), R.layout.version_notifycation);
                ...
                new RequestCallBack<File>() {
                    ...
                    public void onFailure(HttpException error, String msg) {
                        ...
                        if (error.getExceptionCode() == 0) {
                            ...
                            // 更改文字
                            notification.contentView.setTextViewText(R.id.msg, "易贝通");
                            // 更改文字
                    ...
                    public void onLoading(long total, long current, boolean isUploading) {
                        ...
                        System.out.println("总 total = " + total);
                        System.out.println("当前下载current = " + current);
                        if (initTotal == 0) {
                            //说明第一次开始下载
                            initTotal = total;
                        }
                        ...
                        if (initTotal != total) {
                            //说明下载过程中暂停过，文件的总长度出现问题  就把初始的文件的长度赋值给他重新计算已经下载的比例
                            total = initTotal;
                        }

                        long l = current * 100 / total;
                        notification.contentView.setTextViewText(R.id.msg, "正在下载：易贝通");
                        // 更改文字
                    ...
                    @Override
                    public void onStart() {
                        notification.contentView.setTextViewText(R.id.msg, "开始下载：易贝通");
                        nm.notify(titleId, notification);
                    }
