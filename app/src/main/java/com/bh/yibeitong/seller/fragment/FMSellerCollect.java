...
public class FMSellerCollect extends BaseFragment {
    private View view;
    ...
    public static FMSellerCollect newInstance(String name) {
        Bundle bundle = new Bundle();
        bundle.putString("name", name);
        FMSellerCollect fragment = new FMSellerCollect();
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser){
            System.out.println("in FMSellerCollect");
            waitsendSellerOrder(uid, pwd, "", "is_send");
        }else{
            System.out.println("move FMSellerCollect");
        ...
        x.http().get(params,
                new Callback.CommonCallback<String>() {
                    ...
                    public void onSuccess(String result) {
                        System.out.println("商家订单 待收货 = " + result);
    ...
    public class SellerOrderAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            SellerOrderAdapter.ViewHolder vh;
            if (view == null) {
